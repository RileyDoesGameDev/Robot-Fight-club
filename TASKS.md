...
- [x] **T-6.6** Two-player input: gamepad + gamepad, or gamepad + keyboard. Verify the input layer handles two simultaneous devices — **spike this early**; it's the one week-6 item that can surprise you. **(R)**
